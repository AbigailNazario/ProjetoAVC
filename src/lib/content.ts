...
export const SECTIONS: Section[] = [
  {
    ...
    checklist: [
      "Tomar medicamento da pressão arterial diariamente",
  ...
  },
  {
    ...
    checklist: [
      ...
      "Utilizar tabelas disponibilizadas para apoio",
    ],
    accent: "primary",
  },
  {
  ...
  },
  {
    ...
    checklist: [
      ...
      "Seguir orientações da fonodióloga",
    ],
    accent: "secondary",
  },
  {
    ...
    checklist: [
      ...
      "Atenção para sinais de sangramento",
      "Atenção para sonolência"
    ],
    accent: "primary",
  },
];
